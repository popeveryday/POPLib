...
- (void)layoutSubviews {
    ...
    NSRange range = NSMakeRange(0, [detailsLabel.attributedText length]);
    NSDictionary *attributes = [detailsLabel.attributedText attributesAtIndex:0 effectiveRange:&range];
    CGSize boundingBox = [detailsLabel.text boundingRectWithSize:maxSize options: NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
    CGSize detailsLabelSize = CGSizeMake(ceil(boundingBox.width), ceil(boundingBox.height));
